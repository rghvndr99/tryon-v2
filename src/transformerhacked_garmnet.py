...
from diffusers.utils import BaseOutput, deprecate, is_torch_version
# Missing in diffusers 0.21.4
USE_PEFT_BACKEND = False
from src.attentionhacked_garmnet import BasicTransformerBlock
from diffusers.models.embeddings import PatchEmbed  # PixArtAlphaTextProjection not available in diffusers 0.21.4
# Simple replacement for PixArtAlphaTextProjection
class PixArtAlphaTextProjection(nn.Module):
    def __init__(self, in_features, hidden_size, out_features, act_fn="gelu_tanh"):
        super().__init__()
...
# from diffusers.models.normalization import AdaLayerNormSingle  # Not available in diffusers 0.21.4
# Simple replacement
