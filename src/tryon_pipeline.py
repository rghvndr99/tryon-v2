...
PipelineImageInput = Union[PIL.Image.Image, torch.Tensor, np.ndarray]
from diffusers.loaders import (
    FromSingleFileMixin,
    # IPAdapterMixin,  # Not available in diffusers 0.21.4
    StableDiffusionXLLoraLoaderMixin,
    TextualInversionLoaderMixin,
)
from diffusers.models import AutoencoderKL, UNet2DConditionModel  # ImageProjection not available in 0.21.4
from diffusers.models.attention_processor import (
    AttnProcessor2_0,
    # FusedAttnProcessor2_0,  # Not available in diffusers 0.21.4
...
from diffusers.utils import (
    # USE_PEFT_BACKEND,  # Not available in diffusers 0.21.4
    deprecate,
    is_invisible_watermark_available,
    # is_torch_xla_available,  # Not available in diffusers 0.21.4
    logging,
    replace_example_docstring,
    # scale_lora_layers,  # Not available in diffusers 0.21.4
    # unscale_lora_layers,  # Not available in diffusers 0.21.4
)

# Define missing functions for compatibility with diffusers 0.21.4
def is_torch_xla_available():
    return False

def scale_lora_layers(model, weight):
    pass  # Not implemented in diffusers 0.21.4

def unscale_lora_layers(model, weight):
    pass  # Not implemented in diffusers 0.21.4

USE_PEFT_BACKEND = False  # Not available in diffusers 0.21.4
