...
# from diffusers.utils.torch_utils import apply_freeu  # Not available in diffusers 0.21.4
# Define compatibility function
def apply_freeu(resolution_idx, hidden_states, res_hidden_states, **freeu_kwargs):
    return hidden_states, res_hidden_states  # No-op for compatibility
from diffusers.models.activations import get_activation
from diffusers.models.attention_processor import Attention, AttnAddedKVProcessor, AttnAddedKVProcessor2_0
from diffusers.models.dual_transformer_2d import DualTransformer2DModel
from diffusers.models.unet_2d_blocks import AdaGroupNorm  # Changed location in diffusers 0.21.4
